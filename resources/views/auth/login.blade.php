...
<head>
    ...
    <title>Đăng nhập | iPHONE STORE</title>
...
<div class="login-container">
    <div class="login-card">
        ...
        <h5 class="text-center text-muted mb-4">Chào mừng bạn quay trở lại!</h5>
        ...
        <div class="mt-4 text-center">
            <p class="text-muted small">Chưa có tài khoản? <a href="{{ route('register') }}" class="text-primary fw-bold text-decoration-none">Đăng ký ngay</a></p>
            <hr>
